...
function custom_header() { ?>
		...
		<form id="newsletter-signup" name="emailSignUp" method="post" action="http://www.saffronmarigold.com/catalog/email_signup.php">        
    		...
    		<a href="javascript:submitEmail();"><img src="http://saffronmarigold.com/catalog/images/gosign_up.gif" border="0"></a>
    	</form>
...
<ul id="main-nav">
	    ...
	    <li id="shopby-tab"><a href="http://www.saffronmarigold.com/catalog/shop_by_print.php?cPath=59">Shop<br>By</a>
		    <ul>
		    	<li><a href="http://www.saffronmarigold.com/catalog/shop_by_print.php?cPath=59">Print</a>
			    <li><a href="http://www.saffronmarigold.com/catalog/directory.php?cPath=58">Swatches</a></li>
		    </ul>
	    </li>
